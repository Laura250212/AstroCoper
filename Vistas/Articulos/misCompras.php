...
<div class="store-container">
    <div class="store-header">
        <h2 class="store-title">HISTORIAL</h2>
        <p class="store-subtitle">Registro de productos adquiridos</p>
    </div>

    <?php if (empty($pedidos)): ?>
        <div class="card">
            <p>Aún no has realizado ninguna adquisición</p>
            <br>
                ...
                <table class="w3-table" style="width: 100%; border-collapse: collapse; color: #e0e0e0; min-width: 600px;">
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom: 1px solid rgba(0,255,255,0.2);">
                            ...
                            <td style="padding: 15px;">
                                <ul style="font-size: 0.9rem; color: #b0d4ff; list-style: circle; margin-left: 15px; padding-left: 0;">
                                    <?php 
