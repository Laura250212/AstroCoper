...
<div class="store-container">
    ...
    <div class="card" style="text-align: left;"> 
                ...
                <tr style="border-bottom: 1px solid rgba(0,255,255,0.2);">
                    ...
                    <td style="padding: 15px;">
                        <a href="<?php echo RUTA_BASE; ?>/index.php?action=borrarItem&id=<?php echo $item['info']['id']; ?>" 
                           style="color: #ff4444; text-decoration: none;">Eliminar</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        ...
        <div style="margin-top: 30px; text-align: right;">
            ...
            <a href="<?php echo RUTA_BASE; ?>/index.php?action=vaciarCarrito" class="buttons" style="background: rgba(255,0,0,0.2); border-color: #ff4444; color: #ff4444; margin-right: 15px;">
                Vaciar Carga
            </a>
            
            <a href="<?php echo RUTA_BASE; ?>/index.php?action=procesarPedido" class="buttons">
                CONFIRMAR COMPRA
            </a>
        </div>
    </div>
